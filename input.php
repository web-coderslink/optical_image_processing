...
<?php
         $python="tesseract  C:\\xampp\htdocs\myproject\PHPCOURSE\optical_character_recoginision\\$target  C:\\xampp\htdocs\myproject\PHPCOURSE\optical_character_recoginision\\textfiles\\$txtdoc";
...
<div class="container" >
      <form action="input.php" class="form-control">
      ...
      if(isset($_POST["abc"])){  
        echo "clicked";     
        echo file_get_contents("C:\\xampp\htdocs\myproject\PHPCOURSE\optical_character_recoginision\\textfiles\\$abc.txt");
